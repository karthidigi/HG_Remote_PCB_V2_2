...
// Modified for AES-128 in CTR mode only, optimized for AVR128DB48
...
// AES-128 parameters
#define Nk 4 // 4 words in key (128 bits)
#define Nr 10 // 10 rounds for AES-128
#define Nb 4 // 4 words in block (128 bits)
